...
center=findgen(80)/100. + 0.2
norm=findgen(100)/1000. + 0.05
w=0.1
...
; hz43
restore,'/data/neo/HRCI_QE_Jan10/HZ43/hrcs_hz43.sav'

; pks2155
restore,'/data/neo/HRCI_QE_Jan10/PKS2155/3716/pks_model.sav'

; g21.5-0.9
readcol,'/data/neo/HRCI_QE_Jan10/G21.5-0.9/model.txt',e,de,f,skip=3
g21_arf=mrdfits('/data/neo/HRCI_QE_Jan10/G21.5-0.9/hrci_arf_prime_renorm.fits',1,h)
...
save,chisq,norm,center,g21_pred,g21_pred_err,pks_pred,pks_pred_err,hz_pred,hz_pred_err,filename="adjust_qe_NEW.sav"

print,"min chisq: ",min(chisq)

ind=where(chisq eq min(chisq))
tmp=array_indices(chisq,3935) ; ind=3935
