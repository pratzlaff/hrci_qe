...
Pete Ratzlaff E<lt>pratzlaff@cfa.harvard.eduE<gt> February 2018
...
my ($y, $corr) = rcols 'adjust_hrciQE.rdb', 0, 3, { lines => '14:' };
...
sub generate_file {
  ...
  modify_qe($fptr, $factor) if defined $factor;
